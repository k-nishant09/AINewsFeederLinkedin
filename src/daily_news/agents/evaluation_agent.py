    ...
    def __init__(self) -> None:
        ...
        self._judge_prompt = ChatPromptTemplate.from_messages([
            (
                ...
                "### BANNED INLINE PHRASES — INSTANT FAIL (exact match only, not paraphrase):\n"
                "- 'the real question is whether', 'the real question is,'\n"
                "- 'the real challenge lies in', 'the real challenge is', 'the challenge lies in'\n"
                "- 'the key challenge is', 'the key metric is'\n"
                ...
                "- 'but the real test', 'but the real question'\n"
                ...
                "- 'in the end,', 'in the end this', 'more tools do not always', 'my advice to'\n"
                "- 'the real business metric', 'the key business metric'\n"
                "- 'the real test is whether', 'the real issue is', 'the real problem is'\n"
                "- 'the real risk is whether', 'the real opportunity is'\n"
                "NOTE: Only flag these EXACT substrings. Do not flag paraphrases or rewordings.\n\n"
